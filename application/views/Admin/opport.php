...
<html lang="en">
  ...
  <body>
    ...
    <div class="sidenav">
      ...
      <div class="navbar">
        ...
        <a href="<?php echo base_url(); ?>admin/admins">Admins</a>
        <a href="<?php echo base_url(); ?>admin/opport"  class="active">Oportunities</a>
    ...
    <div class="main">
      <h1 class="text-primary text-center">OPPORTUNITIES</h1>
  ...
  <div class="container">
      <div class="row justify-content-center">
        <form action="<?php echo base_url(); ?>admin/opport" method="POST" enctype="multipart/form-data">
        <h1>Add Opportunities</h1>
          <fieldset class="fieldset">
              <div class="form-group">
                ...
                <div class="form-group">
                  <label><h3>Image:</h3></label><br>
                  <input type="file" class="image" name="image">
                </div>
                <div class="form-group">
                  <button type="submit" class="btn btn-primary btn-lg" name="save" value="Add">Save</button>
              </div>
          </fieldset>
        </form>
      </div>
